...
export interface ApiConversationConversation
  ...
  attributes: {
    Conversation_content: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    parent: Schema.Attribute.Relation<'manyToOne', 'api::message.message'>;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    audio_track: Schema.Attribute.Component<'audio-track.audio-track', true>;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::post.post'> &
      Schema.Attribute.Private;
    music_video: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiQuizzQuizz extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answer: Schema.Attribute.Component<'quizz-answer.quizz-answers', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
